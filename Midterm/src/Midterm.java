...
public class Midterm extends Application {  
  ...
  public void start(Stage primaryStage) {     
    ...
    primaryStage.setTitle("Allison Smith Midterm"); // Set the stage title
    ...
    btStep.setOnAction(e -> {    
          ...
          if (status == 0)
        	  ...
        	  for (int i = 0; i < control.getArray().length-1; i++) {
            	  int currentMin = control.getArray()[i];
            	  int currentMinIndex = i;
            	  
            	  
            	  
            	  //for (int j = i+1; j < control.getArray().length; j++) {
            		  //if (currentMin > control.getArray()[j]) {
            			  //currentMin = control.getArray()[j];
            			  //currentMinIndex = j;
        	  ...
        	  pane.setColoredBarIndex(control.getArray()[idx]); 
      			}}// Continue
          else if (status == 1) {
